...
Route::get('cashier/history/invoice/{transactionId}', [CashierController::class, 'downloadInvoice'])->name('cashier.downloadInvoice');
Route::get('/payment-methods', [CashierController::class, 'getPaymentMethods'])->name('payment.methods');
